...
class Characters(BaseModel):
    ...
    charname: str = Field(None, title='Charname')
    ...
    lastactivity: datetime = Field(None, title='Lastactivity')
    ...
    defaultpawnclasspath: str = Field(None, title='Defaultpawnclasspath')
    isinternalnetworktestuser: bool = Field(None, title='Isinternalnetworktestuser')
    classid: int = Field(None, title='Classid')
    isadmin: bool = Field(None, title='Isadmin')
    ismoderator: bool = Field(None, title='Ismoderator')
    createdate: datetime = Field(None, title='Createdate')
    userguid: Optional[str] = Field(None, title='Userguid')
    mapname: Optional[str] = Field(None, title='Mapname')
    serverip: Optional[str] = Field(None, title='Serverip')
    description: Optional[str] = Field(None, title='Description')
    basemesh: Optional[str] = Field(None, title='Basemesh')
